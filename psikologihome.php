...
$query = "SELECT books.*, categories.nama_kategori FROM books JOIN categories ON books.category_id = categories.id_kategori WHERE  category_id IN (4, 7) ORDER BY id DESC; ";
    ...
    <section>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="row">
                ...
                $query = "SELECT books.*, categories.nama_kategori FROM books LEFT JOIN categories ON books.category_id = categories.id_kategori WHERE category_id IN (4,7)";
                if (isset($_POST['cari'])) {
                    $cari = $_POST['cari'];
