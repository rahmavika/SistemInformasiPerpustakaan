...
$query = "SELECT books.*, categories.nama_kategori FROM books JOIN categories ON books.category_id = categories.id_kategori WHERE  category_id IN (9,10) ORDER BY id DESC; ";
    ...
    <section>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="row">
                ...
                $query = "SELECT books.*, categories.nama_kategori FROM books LEFT JOIN categories ON books.category_id = categories.id_kategori WHERE category_id IN (9,10)";
                if (isset($_POST['cari'])) {
                    $cari = $_POST['cari'];
                            ...
                            ?>
                                <div class="card text-white border-secondary" style="background-color:transparent;width: 16rem; height: 28rem; float: left; margin-right: 20px; margin-bottom: 20px; text-align: left; white-space: nowrap; overflow: hidden;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="detail.php?id=<?= $row['id'] ?>" class="btn btn-sm text-white" style="font-size: 18px;background-color: #FF8F01"><i class="fa fa-search"></i>Detail</a>
                                        </tr>
                                    </div>
                                </div>
                            <?php endforeach ?>
